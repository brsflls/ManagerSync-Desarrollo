...
export const Header = () => {
  ...
  return (
    <nav className="bg-white    w-screen h-max  ">
      <div className="w-full  h-max  flex justify-between  ">
        ...
        {/* Navigation Links */}
        <ul className={`md:flex-row md:space-x-8 md:items-center absolute md:static top-16  w-full md:w-auto bg-white md:bg-transparent z-10 transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
