...
<div class="absolute top-0 left-40 w-72 h-72 lg:bg-slate-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
    <div class="absolute top-14 right-24 w-72 h-72 lg:bg-sky-400 rounded-full mix-blend-multiply filter blur-xl bg-opacity-30 opacity-70 animate-blob animation-delay-1000"></div>
    <div class="absolute -bottom-8 left-96 w-72 h-72 lg:bg-blue-500 rounded-full mix-blend-multiply filter blur-xl bg-opacity-30 opacity-70 animate-blob animation-delay-2000"></div>
