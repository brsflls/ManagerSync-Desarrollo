...
export function MantenimientoProductos() {
  ...
  const fetchProductos = () => {
    fetch('http://localhost/managersyncbd/public/api/productos/all')
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost/managersyncbd/public/api/productos', {
      method: 'POST',
      headers: {
  ...
  const handleDelete = (id) => {
    fetch(`http://localhost/managersyncbd/public/api/productos/${id}`, {
      method: 'DELETE',
    })
      .then(response => {
        if (response.ok) {
  ...
  const handleUpdate = (e) => {
    ...
    fetch(`http://localhost/managersyncbd/public/api/productos/${editingProduct}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
