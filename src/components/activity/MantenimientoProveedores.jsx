...
export function MantenimientoProveedores() {
  ...
  const fetchProveedores = () => {
    fetch('http://localhost/managersyncbd/public/api/proveedores/all')
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost/managersyncbd/public/api/proveedores', {
      method: 'POST',
      headers: {
  ...
  const handleDelete = (id) => {
    fetch(`http://localhost/managersyncbd/public/api/proveedores/${id}`, {
      method: 'DELETE',
    })
      .then(response => {
        if (response.ok) {
  ...
  const handleUpdate = (e) => {
    ...
    fetch(`http://localhost/managersyncbd/public/api/proveedores/${editingProveedor}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
